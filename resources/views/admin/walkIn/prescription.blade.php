...
<div class="page-header">
    ...
    <div class="card">
        ...
        <div class="card-header"><h3>Prescription for {{$bookings->user->user_fName}} {{$bookings->user->user_lName}}</h3>
        </div>
        ...
        <div class="card-body">
            ...
            <p><strong>Age:</strong> {{\Carbon\Carbon::parse($bookings->user->user_birthdate)->age}}</p>
            <p><strong>Address:</strong> {{$bookings->user->user_address}} </p>
        </div>
        ...
        <form Action="{{route('prescription.store')}}" method="post">@csrf
            <div class="form-group">
                ...
                <a href="{{route('walkin.index')}}"class="btn btn-secondary"style ="color: white;" >Cancel</a>
