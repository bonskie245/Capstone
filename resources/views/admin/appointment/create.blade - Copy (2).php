...
<div class="container">
    ...
    <div class="card">
        <div class="card-header">
            <i class="bi-sunrise" style="font-size: 20px;"></i><span style="margin-left: 5px">Choose AM time</span>
        ...
        <div class="card">
        <div class="card-header">
            <i class="bi bi-sunset" style="font-size: 20px;"></i><span style="margin-left: 5px">Choose PM time</span>
        </div>
        <div class="card-body">
            ...
            <table class="table table-striped">
              ...
              <tbody>
                <tr>
                  <th scope="row">6</th>
                  <td><input type="checkbox" name="time[]"  value="12pm">12:00pm</td>
